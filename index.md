...
## Clip 1: Ball - triangle interaction

![Screenshot](/pictures/GIF_1_new.gif)

In this clip we can see how the project is started, balls are generated by pressing the spacebar (each new ball can be seen appearing in the list to the left). The balls bounces off the triangular pegs using the reflection angle that light would take, sometimes the balls arrive to the triangle at such an angle that they instead glide over the surface, and some clipping of the models can be observed. 


## Clip 2 - Balls interacting with other balls and triangles

![Screenshot](/pictures/GIF_2_new.gif)
